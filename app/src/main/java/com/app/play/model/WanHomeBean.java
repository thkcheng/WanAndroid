...
public class WanHomeBean {
    ...
    public static class DatasBean {
         ...
         * collect : false
         * courseId : 13
         * desc : Android 仿钉钉、微信 群聊组合头像 CombineBitmap
         * envelopePic : http://www.wanandroid.com/blogimgs/f36e29c7-5475-461c-b27a-d1e9c0dc7b9d.png
         * fresh : false
         * id : 3076
         * link : http://www.wanandroid.com/blog/show/2180
         * niceDate : 2018-06-29
         * origin :
         * projectLink : https://github.com/Othershe/CombineBitmap
         * publishTime : 1530261697000
         * superChapterId : 294
         * superChapterName : 开源项目主Tab
         * tags : [{"name":"项目","url":"/project/list/1?cid=380"}]
         * title : Android 仿钉钉、微信 群聊组合头像 CombineBitmap
         * type : 0
         * userId : -1
         * visible : 1
         * zan : 0

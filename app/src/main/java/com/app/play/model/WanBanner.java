...
public class WanBanner extends BaseModel{
    ...
    private List<WanBannerBean> data;

    public List<WanBannerBean> getData() {
        return data;
    }

    public void setData(List<WanBannerBean> data) {
        this.data = data;
    }

    public static class WanBannerBean {
        /**
         * desc :
         * id : 6

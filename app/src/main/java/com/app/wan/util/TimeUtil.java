...
public class TimeUtil {
    ...
    private static final int MINUTE = 60;               //钟
    ...
    public static String getMixTimeFromTimestamp(long timestamp,
        ...
        if (timeGap <= partionSeconds) {
            return getPublishTime(timestamp);
        } else {
    ...
    public static void test() {
        ...
        try {
            ...
            System.out.println(TimeUtil.getPublishTime(date
                    .getTime()));
            System.out.println(TimeUtil.getPublishTime(new Date()
                    .getTime()));
